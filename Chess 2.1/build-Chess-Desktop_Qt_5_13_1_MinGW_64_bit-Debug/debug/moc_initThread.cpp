...
QT_MOC_LITERAL(3, 23, 10) // "timeToSend"

    },
    "initThread\0sendSignal\0\0timeToSend"
};
...
void initThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<initThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (initThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&initThread::sendSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void initThread::sendSignal(QString _t1)
{
