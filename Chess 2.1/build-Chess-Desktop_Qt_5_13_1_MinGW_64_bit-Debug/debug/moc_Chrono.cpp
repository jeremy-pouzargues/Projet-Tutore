...
#include <memory>
#include "../../GraphicalObject/Chrono.h"
...
QT_MOC_LITERAL(1, 7, 15), // "onSignalReceive"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 10) // "timeToSend"

    },
    "Chrono\0onSignalReceive\0\0timeToSend"
};
...
void Chrono::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Chrono *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onSignalReceive((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject Chrono::staticMetaObject = { {
    ...
    qt_meta_stringdata_Chrono.data,
    qt_meta_data_Chrono,
    qt_static_metacall,
    nullptr,
    nullptr
